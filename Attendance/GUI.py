...
class AttendanceSystemGUI:
    ...
    def on_session_type_select(self, event):
        ...
        if selected_session == "Others":
            ...
            self.other_session_label.grid(row=5, column=0, sticky=tk.W, pady=5)  # Adjusted to row 5
            ...
            self.other_session_entry.grid(row=5, column=1, pady=5)  # Adjusted to row 5
